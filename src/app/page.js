...
const Home = () => {
  ...
  const handleBeforePrint = () => setLoading(true);
  const handleAfterPrint = () => setLoading(false);
  ...
  return (
    <div>
      <div ref={componentRef} className="relative w-full mx-auto">
        <SVGDesign />
        <div className="absolute w-full top-3 !text-white z-30">
      ...
      <div className="flex justify-center">
        <ReactToPrint
          trigger={() => (
            <button className="text-white bg-orange-600 rounded-xl px-3 py-1 mt-5">
              {loading ? <p>Loading...</p> : "Print this out!"}
            </button>
          )}
